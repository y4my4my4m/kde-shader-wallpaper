...
void main()
{
    ...
    vec2 screenSize = vec2(ubuf.iResolution.x/ubuf.iResolution.y, 1.) * 2.;
    ...
    vec2 e = vec2(.8,0)/ubuf.iResolution.y;
    ...
    float ee = rangec(0., 10./ubuf.iResolution.y, ff);
    ...
    // col += (texture(iChannel0, qt_TexCoord0 / ubuf.iResolution) * 2. - 1.) * .005;
